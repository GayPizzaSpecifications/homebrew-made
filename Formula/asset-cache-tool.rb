class AssetCacheTool < Formula
  ...
  homepage "https://github.com/GayPizzaSpecifications/asset-cache-tool"

  url "https://github.com/GayPizzaSpecifications/asset-cache-tool/releases/download/v0.0.1/asset-cache-tool"
